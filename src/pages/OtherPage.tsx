...
export const OtherPage = () => {
  ...
  if (!intId) return <div>Invalid ID, not a number</div>;

  return (
    <div>
      OtherPage
      <MyIcon />
      <InnerOtherPage id={intId} />
    </div>
  );
};

const InnerOtherPage: FC<{ id: number }> = ({ id }) => {
  return <div>{id}</div>;
};
